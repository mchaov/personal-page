...
If you expected me to give a solution - your expectation are not going to be met. I needed to vent my frustration from the direction this library it taking. Making the API more and more complex, instead of focusing on more modular opt-in approach. Confusing FP newbies onto what is FP.
